      ...
      <div className="bg-background border border-border rounded-2xl p-6 sm:p-8 shadow-sm space-y-6">
        <form onSubmit={handleUpdateProfile} className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-foreground">{t("emailAddress")}</label>
              <input
                type="email"
                required
                value={email}
        ...
        <form onSubmit={handleChangePassword} className="pt-6 border-t border-border space-y-6">
          ...
          <div className="space-y-4">
            <div className="space-y-1.5">
              <label className="text-xs font-bold text-foreground">{t("currentPassword")}</label>
              <input
                type="password"
                required
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-foreground">{t("newPassword")}</label>
                <input
                  type="password"
                  required
                  value={newPassword}
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-foreground">{t("confirmNewPassword")}</label>
                <input
                  type="password"
                  required
